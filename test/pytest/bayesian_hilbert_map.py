...
def main():
    ...
    for xy, theta in zip(*trajectory):
        pts_file = f"/home/daizhirui/D/Dev/erl_projects/cmake-build-debug/src/erl_gp_sdf/dataset_points_{traj_idx}.txt"
        y_file = f"/home/daizhirui/D/Dev/erl_projects/cmake-build-debug/src/erl_gp_sdf/dataset_labels_{traj_idx}.txt"
        traj_idx += 1
