...
public:
  SdfGridMapNode() {
    ...
    //TODO querry points. Currently it is a bit naive resolution * cell will give us lengths. Initializating properly with a config might be better.
...
// building the square grid (for now) to get geo messages to push
  std::vector<geometry_msgs::PointStamped> makeQuery(double res, int n) {
