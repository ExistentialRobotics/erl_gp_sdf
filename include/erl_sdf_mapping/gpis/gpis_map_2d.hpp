...
namespace erl::sdf_mapping::gpis {
    ...
    private:
        ...
        InferWithGpX(
            ...
            const Eigen::Ref<Eigen::Vector3d> f,
            const Eigen::Ref<Eigen::Vector3d> var) const override {

            const auto gp = std::static_pointer_cast<const gaussian_process::NoisyInputGaussianProcess>(gp_ptr);
