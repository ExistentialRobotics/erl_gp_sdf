...
namespace erl::sdf_mapping {
    struct GpSdfMappingSetting : public common::Yamlable<GpSdfMappingSetting> {
...
template<>
struct YAML::convert<erl::sdf_mapping::GpSdfMappingSetting::TestQuery> {
    static Node
    encode(const erl::sdf_mapping::GpSdfMappingSetting::TestQuery& rhs) {
        Node node;
    ...
    static bool
    decode(const Node& node, erl::sdf_mapping::GpSdfMappingSetting::TestQuery& rhs) {
...
template<>
struct YAML::convert<erl::sdf_mapping::GpSdfMappingSetting> {
    static Node
    encode(const erl::sdf_mapping::GpSdfMappingSetting& setting) {
        Node node;
    ...
    static bool
    decode(const Node& node, erl::sdf_mapping::GpSdfMappingSetting& setting) {
        if (!node.IsMap()) { return false; }
